# Generated by Django 4.0.2 on 2022-02-10 12:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergie', models.ManyToManyField(to='inscription.Allergie', verbose_name='Allergies')),
                ...
                ('dys', models.ManyToManyField(to='inscription.TroubleCognitif', verbose_name="Troubles de l'apprentissage")),
